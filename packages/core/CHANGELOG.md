...
- [#898](https://github.com/statelyai/xstate/pull/898) [`adb44a4c2`](https://github.com/statelyai/xstate/commit/adb44a4c236f3b985dd3587382118dfe7256af53) Thanks [@davidkpiano](https://github.com/davidkpiano)! - Fixed an issue with exit actions being called in random order when stopping a machine. They should always be called in the reversed document order (the ones defined on children should be called before the ones defined on ancestors and the ones defined on states appearing later in the code should be called before the ones defined on their sibling states).
